...
class App(tk.Frame):
    ...
    money = random.randint(2000, 5000)   # БАЛАНС 
    ...
    """
    TO-DO ПРИ СНЯТИИ/ВНЕСЕНИИ ГЕНЕРИРОВАТЬ РЕЗУЛЬТАТ ОПЕРАЦИИ
    """
    ...
    def getMoney(self):
        ...
        self.acceptButton.place(relx=.398, rely=.389)
    ...
    def verification(self):
        ...
        if pin == '1234':
            ...
            self.pin_text.set('ВВЕДИТЕ ПИН-КОД\nПИН-КОД НЕВЕРНЫЙ')
    ...
    def pinEnter(self, master):
        ...
        self.submit_button.place(relx=.398, rely=.389)
